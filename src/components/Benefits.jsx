...
const benefitsData = [
  {
    ...
    // SVG line coordinate percentages: card (x1, y1) -> central hub (x2, y2)
    lineCoords: { x1: '28%', y1: '18%', x2: '50%', y2: '40%' },
  },
  {
    id: 'faculty',
    number: '02',
    ...
    lineCoords: { x1: '28%', y1: '50%', x2: '37%', y2: '50%' },
  },
  {
    id: 'research',
    number: '03',
    ...
    lineCoords: { x1: '72%', y1: '18%', x2: '50%', y2: '40%' },
  },
  {
    id: 'placement',
    number: '04',
    ...
    lineCoords: { x1: '72%', y1: '50%', x2: '63%', y2: '50%' },
  },
  {
    id: 'hands-on',
    number: '05',
    ...
    lineCoords: { x1: '50%', y1: '82%', x2: '50%', y2: '65%' },
  },
];
  ...
  return (
    <section className={styles.benefitsSection} id="why-vittec" ref={containerRef}>
      <div className="container">
        ...
        >
          <h2 className={styles.title}>Why VIT-TEC Corporate Training</h2>
              ...
              return (
                <g key={item.id}>
                  ...
                  <circle
                    ...
                    cy={y1}
                    r={isActive ? 3.5 : 2.5}
                    className={`${styles.connectorDotCard} ${isActive ? styles.connectorDotActive : ''}`}
                  />
                  {/* Hub anchor dot */}
                  <circle
                    cx={x2}
                    cy={y2}
                    r={isActive ? 4 : 3}
                    className={`${styles.connectorDotHub} ${isActive ? styles.connectorDotActive : ''}`}
                  />
                </g>
              );
            })}
          ...
          <div className={styles.ecosystemGrid}>
            ...
            {benefitsData.map((item, idx) => (
              <motion.div
                ...
                transition={{ duration: 0.48, delay: 0.26 + idx * 0.07, ease: [0.16, 1, 0.3, 1] }}
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.4, delay: 0.34 + idx * 0.07, ease: 'easeOut' }}
                >
                  {item.icon}
                </motion.div>
